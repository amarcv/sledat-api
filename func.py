    ...
    "properties": {
        "bic_raw": {
            ...
            "description": (
                ...
                "small separate box to the right of the serial number. "
                "STOP — do NOT read the line below the check digit box. "
                "Directly below the BIC there is always a 4-character ISO size/type code "
                "such as 22G1, 42G1, 45G1, 40HC, 45R1, etc. "
                "This code looks similar to part of the BIC but it is on a SEPARATE LINE below "
                "and is NEVER part of the BIC. The BIC ends with the single check digit. "
                "For example: if you see '5' in the check digit box and '45G1' on the line below, "
                "output only '5' — never '45G1' or '5 45G1'. "
